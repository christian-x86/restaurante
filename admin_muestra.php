...
?>
  ...
  <?php
  include("conexion.php");
  $sql2 = "SELECT carta.nombre AS `Carta`, seccion.nombre AS `Sección`, plato.nombre AS `Nombre del plato`, formato.nombre AS `Formato`, lineas_carta.precio
  FROM carta
  ...
  WHERE carta.id_carta=".$_POST["carta"]."
